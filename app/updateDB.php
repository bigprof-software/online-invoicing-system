<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('invoice_items', "create table if not exists `invoice_items` (   `id` INT unsigned not null auto_increment , primary key (`id`), `invoice` INT unsigned null , `item` INT unsigned null , `catalog_price` DECIMAL(10,2) unsigned null , `unit_price` DECIMAL(10,2) unsigned null , `qty` DECIMAL(9,3) null default '1' , `price` DECIMAL(9,2) null ) CHARSET utf8", $silent);
