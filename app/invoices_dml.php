...
function invoices_insert(){
	...
	sql('insert into `invoices` set       `code`=' . (($data['code'] !== '' && $data['code'] !== NULL) ? "'{$data['code']}'" : 'NULL') . ', `status`=' . (($data['status'] !== '' && $data['status'] !== NULL) ? "'{$data['status']}'" : 'NULL') . ', `date_due`=' . (($data['date_due'] !== '' && $data['date_due'] !== NULL) ? "'{$data['date_due']}'" : 'NULL') . ', `client`=' . (($data['client'] !== '' && $data['client'] !== NULL) ? "'{$data['client']}'" : 'NULL') . ', `client_contact`=' . (($data['client_contact'] !== '' && $data['client_contact'] !== NULL) ? "'{$data['client_contact']}'" : 'NULL') . ', `client_address`=' . (($data['client_address'] !== '' && $data['client_address'] !== NULL) ? "'{$data['client_address']}'" : 'NULL') . ', `client_phone`=' . (($data['client_phone'] !== '' && $data['client_phone'] !== NULL) ? "'{$data['client_phone']}'" : 'NULL') . ', `client_website`=' . (($data['client_website'] !== '' && $data['client_website'] !== NULL) ? "'{$data['client_website']}'" : 'NULL') . ', `client_comments`=' . (($data['client_comments'] !== '' && $data['client_comments'] !== NULL) ? "'{$data['client_comments']}'" : 'NULL') . ', `subtotal`=' . (($data['subtotal'] !== '' && $data['subtotal'] !== NULL) ? "'{$data['subtotal']}'" : 'NULL') . ', `discount`=' . (($data['discount'] !== '' && $data['discount'] !== NULL) ? "'{$data['discount']}'" : 'NULL') . ', `tax`=' . (($data['tax'] !== '' && $data['tax'] !== NULL) ? "'{$data['tax']}'" : 'NULL') . ', `total`=' . (($data['total'] !== '' && $data['total'] !== NULL) ? "'{$data['total']}'" : 'NULL') . ', `comments`=' . (($data['comments'] !== '' && $data['comments'] !== NULL) ? "'{$data['comments']}'" : 'NULL') . ', `invoice_template`=' . (($data['invoice_template'] !== '' && $data['invoice_template'] !== NULL) ? "'{$data['invoice_template']}'" : 'NULL') . ', `created`=' . "'{$data['created']}'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function invoices_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `invoices` set       `code`=' . (($data['code'] !== '' && $data['code'] !== NULL) ? "'{$data['code']}'" : 'NULL') . ', `status`=' . (($data['status'] !== '' && $data['status'] !== NULL) ? "'{$data['status']}'" : 'NULL') . ', `date_due`=' . (($data['date_due'] !== '' && $data['date_due'] !== NULL) ? "'{$data['date_due']}'" : 'NULL') . ', `client`=' . (($data['client'] !== '' && $data['client'] !== NULL) ? "'{$data['client']}'" : 'NULL') . ', `client_contact`=' . (($data['client_contact'] !== '' && $data['client_contact'] !== NULL) ? "'{$data['client_contact']}'" : 'NULL') . ', `client_address`=' . (($data['client_address'] !== '' && $data['client_address'] !== NULL) ? "'{$data['client_address']}'" : 'NULL') . ', `client_phone`=' . (($data['client_phone'] !== '' && $data['client_phone'] !== NULL) ? "'{$data['client_phone']}'" : 'NULL') . ', `client_website`=' . (($data['client_website'] !== '' && $data['client_website'] !== NULL) ? "'{$data['client_website']}'" : 'NULL') . ', `client_comments`=' . (($data['client_comments'] !== '' && $data['client_comments'] !== NULL) ? "'{$data['client_comments']}'" : 'NULL') . ', `subtotal`=' . (($data['subtotal'] !== '' && $data['subtotal'] !== NULL) ? "'{$data['subtotal']}'" : 'NULL') . ', `discount`=' . (($data['discount'] !== '' && $data['discount'] !== NULL) ? "'{$data['discount']}'" : 'NULL') . ', `tax`=' . (($data['tax'] !== '' && $data['tax'] !== NULL) ? "'{$data['tax']}'" : 'NULL') . ', `total`=' . (($data['total'] !== '' && $data['total'] !== NULL) ? "'{$data['total']}'" : 'NULL') . ', `comments`=' . (($data['comments'] !== '' && $data['comments'] !== NULL) ? "'{$data['comments']}'" : 'NULL') . ', `invoice_template`=' . (($data['invoice_template'] !== '' && $data['invoice_template'] !== NULL) ? "'{$data['invoice_template']}'" : 'NULL') . ', `created`=`created`' . ', `last_updated`=' . "'{$data['last_updated']}'" . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
