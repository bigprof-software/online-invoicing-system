...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="invoices_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/attributes_display.png"> 					Invoices Filters</a>
			</h1></div>

		
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Date due</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Date due</label></div>
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text"  class="form-control" id="from-date_4"  name="FilterValue[1]" value="<?php echo htmlspecialchars($FilterValue[1]); ?>" size="10">
		</div>
		...
		<div class="col-xs-9 col-md-3 col-lg-2 vspacer-md">
			<input type="text" class="form-control" id="to-date_4" name="FilterValue[2]" value="<?php echo htmlspecialchars($FilterValue[2]); ?>" size="10">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Client</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Client</label></div>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<input type="hidden" class="optionsData" name="FilterField[4]" value="3">
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<input type="hidden" name="FilterValue[4]" id="3_currValue" value="<?php echo htmlspecialchars($FilterValue[4]); ?>" size="3">

	
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[4]" class="filter_3" value='Unpaid'>Unpaid				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[4]" class="filter_3" value='Paid'>Paid				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[4]" class="filter_3" value='Cancelled'>Cancelled				</label>
			</div>
	 		</div>
	...
	<script>
		//for population
		var filterValue_3 = '<?php echo htmlspecialchars($FilterValue[ 4 ]); ?>';
		$j(function () {
			if (filterValue_3) {
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Discount %</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Discount %</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Total</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Total</label></div>
		
					
		<div class="col-xs-3 col-md-1 vspacer-lg text-center">Between</div>
		<input type="hidden" name="FilterAnd[8]" value="and">
		<input type="hidden" name="FilterField[8]" value="15">   
