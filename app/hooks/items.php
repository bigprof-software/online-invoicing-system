<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'items' table. 
	...
	*/
	...
	function items_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function items_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function items_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['item_description'], $data['unit_price']
	...
	*/
	...
	function items_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function items_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['item_description'], $data['unit_price']
	...
	*/
	...
	function items_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function items_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function items_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function items_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function items_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function items_batch_actions(&$args) {
