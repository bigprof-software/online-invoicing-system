<?php
	...
	*/
	 ...
	 *     $data['name'], $data['contact'], $data['title'], $data['address'], $data['city'], $data['country'], $data['phone'], $data['email'], $data['website'], $data['comments']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['name'], $data['contact'], $data['title'], $data['address'], $data['city'], $data['country'], $data['phone'], $data['email'], $data['website'], $data['comments'], $data['unpaid_sales'], $data['paid_sales'], $data['total_sales']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['contact'], $data['title'], $data['address'], $data['city'], $data['country'], $data['phone'], $data['email'], $data['website'], $data['comments']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['contact'], $data['title'], $data['address'], $data['city'], $data['country'], $data['phone'], $data['email'], $data['website'], $data['comments'], $data['unpaid_sales'], $data['paid_sales'], $data['total_sales']
