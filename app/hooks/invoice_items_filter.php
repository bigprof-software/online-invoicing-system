...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="invoice_items_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/barcode.png"> 					Invoice items Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Invoice</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Invoice</label></div>
			...
			if ($j("#filterfield_2").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "invoice_items",                //table name
						f: "invoice"               //field name
					}
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Item</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Item</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Qty</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Qty</label></div>
